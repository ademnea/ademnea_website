    ...
    <div class="relative p-3 mt-2 overflow-x-auto shadow-md sm:rounded-lg">
                    ...
                    <tr
                        ...
                        <td class="px-6 py-4">
                            ...
                            <div class="flex space-x-2">
                                <a href="#" style="color: white; background-color: #28a745; padding: 6px 12px; border-radius: 5px; font-size: 0.75rem; font-weight: 600;" type="button" data-modal-target="{{ $item->longitude }}" data-modal-show="{{ $item->longitude }}" class="inline-flex items-center">View</a>
                                <a href="#" style="color: white; background-color: #ffc107; padding: 6px 12px; border-radius: 5px; font-size: 0.75rem; font-weight: 600;" type="button" data-modal-target="{{ $item->id }}" data-modal-show="{{ $item->id }}" class="inline-flex items-center">Edit</a>
                                <a href="{{ url('/hive_data/' . $item->id) }}" style="color: white; background-color: #007bff; padding: 6px 12px; border-radius: 5px; font-size: 0.75rem; font-weight: 600;" class="inline-flex items-center">Hive Data</a>
                                <a href="#" style="color: white; background-color: #dc3545; padding: 6px 12px; border-radius: 5px; font-size: 0.75rem; font-weight: 600;" type="button" data-modal-target="popup-modal" data-modal-show="popup-modal" class="inline-flex items-center">Delete</a>
                            </div>
        ...
        <div id="addHive" tabindex="-1" aria-hidden="true"
            ...
            <div class="relative w-full max-w-2xl max-h-full">
                <!-- Modal content -->
                <form action="{{ url('/admin/hive/') }}" method="POST"
