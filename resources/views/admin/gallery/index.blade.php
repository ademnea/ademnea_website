            ...
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                ...
                <td class="px-6 py-4">
                    ...
                    <div class="flex space-x-2">
                        <a href="#" type="button" data-modal-target="{{ $item[0]->title }}" data-modal-show="{{ $item[0]->title }}" style="color: white; background-color: #28a745; padding: 6px 12px; border-radius: 5px; font-size: 0.75rem; font-weight: 600;" class="inline-flex items-center">View</a>
                        <a href="#" type="button" data-modal-target="{{ $item[0]->id }}" data-modal-show="{{ $item[0]->id}}" style="color: white; background-color: #ffc107; padding: 6px 12px; border-radius: 5px; font-size: 0.75rem; font-weight: 600;" class="inline-flex items-center">Edit</a>
                ...
                {{-- <td class="px-6 py-4">
                    <a href="#" data-modal-target="{{ $item[0]->id }}" data-modal-show="{{ $item[0]->id }}" style="color: white; background-color: #ffc107; width: auto; height: 30px; padding: 5px; border-radius: 5px;" class="">Edit</a>
                </td> --}}
            </tr>
            @endforeach
        </tbody>
...
<div class="relative w-full max-w-md max-h-full">
    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
        ...
        <div class="p-6 text-center">
           ...
           <form id="delete-user-form-{{ $item[0]->id}}" method="POST" action="{{ url('admin/gallery#' . '/' . $item[0]->id) }}" accept-charset="UTF-8" style="display:inline">
            {{ method_field('DELETE') }}
            {{ csrf_field() }}
