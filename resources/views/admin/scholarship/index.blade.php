            ...
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                ...
                <td class="px-6 py-4">
                    <div class="flex space-x-2">
                        <a href="#" data-modal-target="{{ $item->category }}" data-modal-show="{{ $item->category }}" style="color: white; background-color: #28a745; padding: 6px 12px; border-radius: 5px; font-size: 0.75rem; font-weight: 600;" class="inline-flex items-center">View</a>
                        ...
                        <a href="#" data-modal-target="popup-modal" data-modal-show="popup-modal" style="color: white; background-color: #dc3545; padding: 6px 12px; border-radius: 5px; font-size: 0.75rem; font-weight: 600;" class="inline-flex items-center">Delete</a>
                    </div>
                </td>
            </tr>
            @endforeach
